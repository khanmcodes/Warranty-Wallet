...
export default function Sidebar({ 
  ...
  return (
    <>
      ...
      <div className={`fixed md:static h-screen bg-gradient-dark border-r border-borderColor shadow-dark transition-all duration-300 z-20
        w-64 md:w-64
        ${isMobileMenuOpen ? 'left-0' : '-left-full md:left-0'}`
      }>
        {/* Logo and title */}
        <div className="flex flex-col items-center pt-6 pb-8">
          <img src={logo} alt="Warranty Wallet Logo" className="w-16 h-16 object-contain drop-shadow-lg" />
          <h1 className="mt-2 text-xl font-bold bg-gradient-primary bg-clip-text text-transparent">Warranty Wallet</h1>
        </div>
